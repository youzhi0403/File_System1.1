...
public class RegionQueryByNotReport extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<Region> list = regionService.regionQueryByNotRetreat("3", "outputRetreat", pagination);
			int count = regionService.regionCountByNotRetreat("3", "outputRetreat");
