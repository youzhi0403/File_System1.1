...
public class RegionQueryByMyReport extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			List<Region> list = regionService.regionQueryByMySelf(userId,"outputRetreat",pagination,"3");
			int count = regionService.regionCountByMySelf(userId,"outputRetreat","3");
