...
public class RegionQueryByNotModel extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			List<Region> list = regionService.regionQueryByNotRetreat("2", "modelRetreat", pagination);
			int count = regionService.regionCountByNotRetreat("2", "modelRetreat");
