...
public class RegionQueryByMyModel extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			List<Region> list = regionService.regionQueryByMySelf(userId,"modelRetreat",pagination,"2");
			int count = regionService.regionCountByMySelf(userId,"modelRetreat","2");
