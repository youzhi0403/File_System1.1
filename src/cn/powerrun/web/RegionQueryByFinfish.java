...
public class RegionQueryByFinfish extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			List<Region> list = regionService.regionQueryByStatus("4",pagination);
			
			int count = regionService.regionCountByStatus("4");
